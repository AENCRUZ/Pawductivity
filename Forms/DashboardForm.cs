...
public class DashboardForm : Form
{
    ...
    // ── BUBBLE TIMER ─────────────────────────────────────────────────
    private static readonly string[] CatHappy  = ["Purrrr~ 💜", "Meow! ✨", "Meowiee~", "*purring*", "Nyaa~ 🎵", "Purrfect! 💜"];
    private static readonly string[] CatIdle   = ["Meow?", "...zzzz", "*yawns*", "Meowie?", "*stares*", "Mew~"];
